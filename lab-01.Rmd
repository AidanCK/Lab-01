...
NA stands for "not available" and we are getting this result because some of the values of n_2021 are NA and so a valid mean or median cannot be computed using all the data
...
na.rm determines whether or not to remove NA values before computing the mean/median
...
The mean is much larger than the median because some attractions have many more visitors than either average and these attractions inflate the mean while having little effect on the median
